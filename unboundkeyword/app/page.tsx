...
export default function HomePage() {
  ...
  function handleSearch(e: FormEvent) {
    e.preventDefault();
    const q = query.trim();
    if (q) router.push(`/pricing?q=${encodeURIComponent(q)}&platform=${activeTab}`);
  }
      ...
      <section className="ubk-below-fold py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <Link href="/pricing" className="ubk-btn-primary font-bold px-8 py-3 rounded-full inline-block text-sm">
