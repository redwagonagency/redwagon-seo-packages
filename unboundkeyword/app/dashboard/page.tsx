  ...
  return (
    <div className="p-8 max-w-5xl">
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-1">Here's what's happening with your keywords.</p>
      </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <p className="text-indigo-200 text-sm mt-1">
              AnswerThePublic-style discovery — questions, prepositions, A–Z
            </p>
          </Link>
          <Link
          ...
          >
            ...
            <div className="font-bold">Competitor Gap</div>
          ...
          >
            <div className="text-2xl mb-2">🤖</div>
            <div className="font-bold">LLM Visibility</div>
            <p className="text-emerald-100 text-sm mt-1">
              Check if you appear in AI-generated answers
            </p>
          </Link>
        </div>
      </div>
